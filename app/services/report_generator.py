...
def render_report_html(data: dict, template_name: str = "report.html") -> str:
    logger.info("[report_generator.py] Starting render_report_html function")
...
def generate_pdf_report(
    ...
    logger.info("[report_generator.py] Starting generate_pdf_report function")
    ...
    try:
        logger.info("[report_generator.py] Stage: Attempting PDF generation with WeasyPrint")
    ...
    logger.info("[report_generator.py] Stage: Falling back to xhtml2pdf")
